  ...
  return (
    <div id="mission" className="mission-container">
      <div className="missionTitle">
        <h2>
          <span className="line">_____</span>MISSION
          <span className="line">_____</span>
        </h2>
      </div>
      <div className="content">
        <p className="para">
          The mission of this series is to take you from{" "}
          <b>Zero to Hero in React</b>. During this journey, you will learn
          everything by watching videos and then implement it by building
          projects.
        </p>
        <p className="para">
        ...
        <p className="para">
          ...
          frontend web applications from scratch.
        </p>
